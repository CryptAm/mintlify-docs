...
<Info>
Два проекта сообщества, [BaseX](https://basex-test.vercel.app/swap?currencyA=ETH&currencyB=0x036CbD53842c5426634e7929541eC2318f3dCF7e&focus=source) и [DapDap](https://testnet.base.dapdap.net/uniswap/swap), предоставляют тестовые интерфейсы для контрактов Uniswap, если вы предпочитаете взаимодействовать через браузер, а не напрямую с контрактами.
</Info>
